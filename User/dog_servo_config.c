...
static const DogServoConfig_t s_dog_servo_configs[DOG_SERVO_COUNT] = {
    [DOG_SERVO_LF_KNEE] = {1, -1, 500, -20, 300, 800}, //500 - 200 = 300
    [DOG_SERVO_LF_HIP]  = {2, -1, 500, -15, 200, 795}, // 435+260 = 695
    [DOG_SERVO_RF_KNEE] = {3, 1, 500, -5, 200, 645},
    [DOG_SERVO_RF_HIP]  = {4, 1, 500, 27, 189, 800},
    [DOG_SERVO_LB_KNEE] = {5, -1, 500, -15, 292, 1000},
    [DOG_SERVO_LB_HIP]  = {6, -1, 500, -10, 200, 920},
    [DOG_SERVO_RB_KNEE] = {7, 1, 500, -1, 0, 705},
